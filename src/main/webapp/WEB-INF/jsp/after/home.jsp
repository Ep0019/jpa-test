...
<head>
    ...
    <link href="${ctx}/easyui/css/default.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="${ctx}/easyui/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="${ctx}/easyui/js/themes/icon.css" />
    <script type="text/javascript" src="${ctx}/easyui/js/jquery.min.js"></script>
    <script type="text/javascript" src="${ctx}/easyui/js/jquery.easyui.min.js"></script>
	<script type="text/javascript" src='${ctx}/easyui/js/easyui.operate.js'> </script>
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"控件使用",
							"menus":[
									{"menuid":"12","menuname":"疯狂秀才","icon":"icon-add","url":"http://hxling.cnblogs.com"},
									{"menuid":"13","menuname":"用户管理","icon":"icon-users","url":"http://www.baidu.com"},
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    <img src="${ctx}/easyui/images/noscript.gif" alt='抱歉，请开启脚本支持！' />
</div>
</noscript>
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="${ctx}/easyui/images/blocks.gif" width="20" height="20" align="absmiddle" /> jQuery.EasyUI- 1.2.2 应用实例</span>
    </div>
