...
import com.lhy.netty.fileupload.client.util.MD5FileUtil;
...
public class FileTransferClient {
	...
	public static void main(String[] args) {
		...
		try {
			...
			File file = new File("G://src基于Netty5.0中级案例九之NettyServer收取数据存库【缓存到队列由单独线程处理】.zip");  //  "D://files/xxoo"+args[0]+".amr"
